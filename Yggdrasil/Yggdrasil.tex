...
\begin{enumerateCustom}
	...
	\item Setup Enemy card deck. For harder game replace 1 to 6 Enemy cards with the appropriate Angry Enemy Card. For an even harder game add some Ragnarok cards. Note, more players means harder game.
