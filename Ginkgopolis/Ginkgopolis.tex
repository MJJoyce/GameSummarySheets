...
\begin{itemizeCustom}
	...
	\item For each district in the city (district is area formed by two or more adjacent colors of same color):
		\begin{itemizeCustom}
			\item Player with highest number of resources in district gets points equal to total number of resources in district.
			\item Player with second highest gets points equal to his number of resources.
			\item If there's a tie, player with highest building wins. If still a tile, the number on the highest buildings is used to break the tie.
		\end{itemizeCustom}
\end{itemizeCustom}
