...
\begin{itemizeCustom}
	\item \textbf{Programs:} Pay install cost, place faceup in program row. If installed programs' \memoryUnit costs are greater than Runner's available \memoryUnit, programs must be trashed.
