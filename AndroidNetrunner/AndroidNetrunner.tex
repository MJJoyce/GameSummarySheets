...
\newcommand{\recurringCreditWithColon}{\includegraphics[scale=0.45]{images/recurringCreditLarge.jpg}\textbf{:}\hspace{0.3em}}
% "Link" Images
\newcommand{\link}{\includegraphics[scale=0.40]{images/linkLarge.jpg}\hspace{0.3em}}
\newcommand{\linkWithColon}{\includegraphics[scale=0.45]{images/linkLarge.jpg}\textbf{:}\hspace{0.3em}}
% "Memory Unit" Images
\newcommand{\memoryUnit}{\includegraphics[scale=0.40]{images/memoryUnitLarge.jpg}\hspace{0.3em}}
\newcommand{\memoryUnitWithColon}{\includegraphics[scale=0.45]{images/memoryUnitLarge.jpg}\textbf{:}\hspace{0.3em}}
% "Subroutine" Images
\newcommand{\subroutine}{\includegraphics[scale=0.40]{images/subroutineLarge.jpg}\hspace{0.3em}}
\newcommand{\subroutineWithColon}{\includegraphics[scale=0.45]{images/subroutineLarge.jpg}\textbf{:}\hspace{0.3em}}
% "Trash" Images
\newcommand{\trash}{\includegraphics[scale=0.40]{images/trashLarge.jpg}\hspace{0.3em}}
\newcommand{\trashWithColon}{\includegraphics[scale=0.45]{images/trashLarge.jpg}\textbf{:}\hspace{0.3em}}
