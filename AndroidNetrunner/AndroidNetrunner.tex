...
\fancyhead{}
\fancyfoot[C]{Android Netrunner Summary Sheet v2.0}
...
% Set number styles for enumerate environments
...
\begin{enumerateCustom}
    ...
    \item \textbf{Discard Phase:} Discard down to maximum hand size (initially 5), if necessary
\end{enumerateCustom}
Possible actions:
\begin{enumerateCustom}
