...
\begin{itemizeCustom}
	\item Visit the Village - Reveal your hand (mandatory). Use any Village abilities (optional) and all Trophy effects (mandatory). Use gold value of cards to buy one hero or village card (optional). Spend XP to level up Heroes in your hand (optional). May level multiple Heroes but only one level each.
